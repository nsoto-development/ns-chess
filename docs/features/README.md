...
| `[vs-ai.md](vs-ai.md)`                   | Stockfish opponent in a Web Worker (P1; **M1 planned**)               |
| `[drag-and-drop.md](drag-and-drop.md)`   | Mouse and touch piece dragging layered on click-to-move (P1; **M1 shipped**) |
